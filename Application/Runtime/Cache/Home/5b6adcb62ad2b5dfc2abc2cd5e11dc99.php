...
<!-- <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">
    ...
    <link rel="stylesheet" href="/xmcy/public/home/css/sign.css">
	 <section class="sign">
        <div class="container">
            <div class="sign-content">
                ...
                <form id="i-login" class="form-horizontal clear" action="<?php echo U('Login/index');?>" method="post">


                    <div class="form-group">
                        <label class="i1"></label>

                        <input class="form-control" type="text" name="tel" value="" placeholder="请输入手机号">

                    </div>

                    <div class="form-group">
                        <label class="i2"></label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="submit" name="" value="登录">
                        
                    </div>

                    <div  class="form-group s-a clear">

                        <a href="<?php echo U('Register/index');?>">免费注册</a>
                        <a href="<?php echo U('Login/pwd_reset');?>">忘记密码?</a>
                    </div>
...
<!-- 	<form id="loginForm" method="post" action="<?php echo U('Login/index');?>">
		<label>手机号</label>
...
<!--     </script> -->
   ...
   <script>
    ...
    <script src="/xmcy/public/home/js/bootstrapValidator.min.js"></script>
    <script src="/xmcy/public/home/js/sign.js"></script>
<script type="text/javascript">
	$(function(){
		
		$("#i-login").on('submit',function(){
			var data=$("#i-login").serialize();
