                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="div_button" style="margin-bottom:5px;">
                            <form id="search_form" action="<?php echo U('News/index');?>" method="get">
                                <select name="category_id">
                                    <option value="all">所有分类</option>
                                    <?php if(is_array($category)): foreach($category as $key=>$v): ?><option value="<?php echo ($v["category_id"]); ?>" <?php if($v["category_id"] == $category_id): ?>selected="selected"<?php endif; ?>><?php echo ($v["category_name"]); ?></option><?php endforeach; endif; ?>
                                </select>
                                ...
                                <tbody>
                                    <?php if(count($list) != '0'): if(is_array($list)): foreach($list as $key=>$v): ?><tr align="center">
                                      ...
                                      <!--   <td style="width:10%;padding:4px 0;">
                                        ...
                                        <td><?php echo (get_categoryname_byid($v["category_id"])); ?></td>
                                      <!--   <td><?php echo ($v["report"]); ?></td> -->
                                        <!-- <td><?php echo ($v["bepraise"]); ?></td> -->
                                        <td><?php echo (date('Y-m-d H:i:s',$v["addtime"])); ?></td>
                                 <!--        <td><?php echo ($v["froms"]); ?></td> -->

                                       <!--  <td class="select-state" data-id="<?php echo ($v["id"]); ?>">
                                            <?php if($v['state']==1): ?><img src="/xmcy/public/img/effect/checked.png">
                                        <?php else: ?>
                                                <img src="/xmcy/public/img/effect/unchecked.png"><?php endif; ?>

                                        </td> -->
                                        <td class="effect">
                                            <a href="<?php echo U('News/edit',array('id'=>$v['id']));?>"><img src="/xmcy/public/img/effect/update.png"  alt="查看" title="查看"></a>&nbsp;&nbsp;
