        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form id="logo_upload" class="form-horizontal" action="<?php echo U('index/add');?>" method="post" enctype="multipart/form-data">
                                <div class="content">
                                    ...
                                    <fieldset>
                                        <div class="form-group" style="height:400px;line-height:400px;">
                                            ...
                                            <div class="col-sm-6">
                                                <img id="show_img" style="height:200px;width:800px;line-height:400px;" src="/xmcy/<?php echo ($result["image"]); ?>">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                               ...
                               <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <?php if(is_array($state)): foreach($state as $key=>$vo): ?><option value="<?php echo ($key); ?>" <?php if(($key == $result['is_see'])): ?>selected="seleted"<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; ?>
                                              </select>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input value="<?php echo ($result["address"]); ?>" class="form-control" id="froms" type="text" name="address"  style="width:40%;"/> 
                                ...
                                <div class="footer text-left">
                                    ...
                                    <button id="button_no" type="button" class="btn btn-info btn-fill" onclick="window.location.href='/xmcy/admin.php/Index/index.html'">返回</button>
                                </div>
                                <br/>
                            </form>
                        </div>
