        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">城市查看</a>
                </div>
            </div>
        </nav>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form  class="form-horizontal" action="<?php echo U('Partner/edit_form');?>" method="post" enctype="multipart/form-data">
                                <div class="content">
                                    <legend>城市查看</legend>
                                   ...
                                   <!--  <fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input value="<?php echo ($Partner["title"]); ?>" class="form-control" id="title" type="text" name="title"  style="width:40%;"/> 
                                            </div>
                                        </div>
                                    </fieldset>
                                   ...
                                   <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <script name='content' id="editor" type="text/plain" style="width:110%;height:500px;"><?php echo (htmlspecialchars_decode($Partner["content"])); ?></script>
                                                <script type="text/javascript">
                                ...
                                <div class="footer text-left">
                                 ...
                                 <input id="button_yes" type="submit" value="提交" class="btn btn-info btn-fill"></button>
                                    <a href="<?php echo U('Partner/index');?>"><button id="button_no" type="button" class="btn btn-info btn-fill">返回</button></a>
...
<script>
    ...
    $('li.Partner-<?php echo ($url); ?>').addClass('active');
