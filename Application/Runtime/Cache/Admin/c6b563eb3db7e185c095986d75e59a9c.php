        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">资讯查看</a>
                </div>
            </div>
        </nav>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form  class="form-horizontal" action="<?php echo U('News/edit_form');?>" method="post" enctype="multipart/form-data">
                                <div class="content">
                                    <legend>资讯查看</legend>
                                   ...
                                   <!--  <fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group" style="height:100px;line-height:100px;">
                                            ...
                                            <div class="col-sm-6">
                                                <img id="show_img" src="/xmcy/<?php echo ($production["path"]); ?>" style="width:180px;height:100px;">
                                            </div>
                                        </div>
                                    </fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="navi_id" id="navi_id" class="form-control" required="required" style="width:121%;">
                                                    <?php if(is_array($navigation)): foreach($navigation as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" data-id="<?php echo ($v["id"]); ?>"><?php echo ($v['menu']); ?></option><?php endforeach; endif; ?>
                                                </select>
                                            </div>
                                        </div>
                                    </fieldset> -->
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input value="<?php echo ($news["title"]); ?>" class="form-control" id="title" type="text" name="title"  style="width:40%;"/> 
                                            </div>
                                        </div>
                                    </fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="category_id">
                                                    ...
                                                    <?php if(is_array($category)): foreach($category as $key=>$v): ?><option value="<?php echo ($v["category_id"]); ?>" <?php if($v["category_id"] == $news['category_id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["category_name"]); ?></option><?php endforeach; endif; ?>
                                                </select>
                               ...
                               <!--     <fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group" style="height:100px;line-height:100px;">
                                            <label class="col-sm-2 control-label">图片预览</label>
                                            <div class="col-sm-6">
                                                <img id="show_img" style="width: 150px;height: 100px;" src="/xmcy/<?php echo ($news["image"]); ?>">
                                            </div>
                                        </div>
                                    </fieldset> -->
                         <!--             <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea  id="abstract" class="form-control text" name="abstract"  placeholder="300字以内" ><?php echo ($news["abstract"]); ?></textarea>
                                            </div>
                                        </div>
                                    </fieldset> -->
                                  <!--   <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input value="<?php echo ($evidence["bepraise"]); ?>" class="form-control" type="text" name="bereport" number="true" style="width:40%;" onkeyup="value=value.replace(/[^\S]+/g,'')"/>
                                            </div>
                                        </div>
                                    </fieldset> -->
                                     <!--  <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input value="<?php echo ($report["betel"]); ?>" class="form-control" type="text" name="betel" number="true" style="width:40%;" onkeyup="value=value.replace(/[^\S]+/g,'')"/>
                                            </div>
                                        </div>
                                    </fieldset> -->
                                   <!--   <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <?php echo (date('Y-m-d H:i:s',$news["addtime"])); ?>
                                            </div>
                                        </div>
                                    </fieldset> -->
                                  <!--   <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <script name='content' id="editor" type="text/plain" style="width:110%;height:500px;"><?php echo ($evidence["content"]); ?></script>
                                                <script type="text/javascript">
                            ...
                            <!--         <fieldset>
                                   ...
                                   <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <script name='content' id="editor" type="text/plain" style="width:110%;height:500px;"><?php echo (htmlspecialchars_decode($news["content"])); ?></script>
                                                <script type="text/javascript">
                                                var ue = UE.getEditor('editor');
                                                </script>
                                            </div>
                                ...
                                <div class="footer text-left">
                                 ...
                                 <input id="button_yes" type="submit" value="提交" class="btn btn-info btn-fill"></button>
                                    <a href="<?php echo U('News/index');?>"><button id="button_no" type="button" class="btn btn-info btn-fill">返回</button></a>
