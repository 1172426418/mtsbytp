                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="div_button" style="margin-bottom:5px;">
                            <form id="search_form" action="<?php echo U('Partner/index');?>" method="get">
                        ...
                        <div class="card">
                            ...
                            <!--     <th class="text-center">资讯来源</th> -->
                                ...
                                <tbody>
                                 ...
                                 <!--        <td><?php echo ($v["froms"]); ?></td> -->
                                       ...
                                       <!--  <td class="select-state" data-id="<?php echo ($v["id"]); ?>">
                                        ...
                                        <td class="effect">
                                            <a href="<?php echo U('Partner/edit',array('id'=>$v['id']));?>"><img src="/xmcy/public/img/effect/update.png"  alt="查看" title="查看"></a>&nbsp;&nbsp;
                                ...
                                <tr class="text-center">
                                   ...
                                   <?php else: ?>
                                        <tr align="center"><td colspan="3">暂无数据！</td> </tr><?php endif; ?>
                                </tbody>
                            </table>
                        </div><!--  end card  -->
                    </div> <!-- end col-md-12 -->
