        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">资讯添加</a>
                </div>
            </div>
        </nav>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form  class="form-horizontal" action="<?php echo U('News/add');?>" method="post" enctype="multipart/form-data">
                                <div class="content">
                                    <legend>资讯添加</legend>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input value="" class="form-control" id="title" type="text" name="title"  style="width:40%;"/> 
                                            </div>
                                        </div>
                                    </fieldset>
                             <!--        <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input value="" class="form-control" id="froms" type="text" name="froms"  style="width:40%;"/> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="category_id">
                                                    <?php if(is_array($category)): foreach($category as $key=>$v): ?><option value="<?php echo ($v["category_id"]); ?>"><?php echo ($v["category_name"]); ?></option><?php endforeach; endif; ?>
                                                </select>
                               ...
                               <!--    <fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea  id="abstract" name="abstract" class="form-control text" placeholder="300字以内" ></textarea>
                                            </div>
                                        </div>
                                    </fieldset> -->
...
<script>
    ...
    //     if($('#select_img').val()=='' && $('#show_img').attr('src')!='/xmcy/<?php echo ($production["path"]); ?>'){
    //         One_button('请选择图片');
    //     }else if($('#title').val()==''){
    //         One_button('请输入标题');
